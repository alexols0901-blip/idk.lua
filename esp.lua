...
discordBtn.MouseButton1Click:Connect(function()
 local url = "https://discord.gg/xzx-hub-scripts-1421555487383748660"
...
task.spawn(function()
 while true do
 TweenService:Create(titleGradient, TweenInfo.new(6, Enum.EasingStyle.Linear), {Rotation
= titleGradient.Rotation + 360}):Play()
 task.wait(6)
 end
end)
...
local function moveToWaypoint()
 ...
 if dist < 5 then
 if (currentWaypoint == 4 or currentWaypoint == 6) and not grabDetectedThisSession
then
...
local function startDuel()
 ...
 if (root.Position - Vector3.new(-475,-7,96)).Magnitude > (root.Position -
Vector3.new(-474,-7,23)).Magnitude then
 waypoints = {
